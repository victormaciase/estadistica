...
$$Coeficiente \hspace{0.2cm} de \hspace{0.2cm} variación \hspace{0.2cm} = \left(\frac{\sigma_x}{\overline x} \times 100\right )\%$$
...
loan50 %>% ggplot(aes(x = interest_rate)) + 
  ...
  scale_x_continuous(labels = scales::percent_format(scale = 1, accuracy = 1), limits = c(0, 30)) +
