...
A continuación se presentan las primeras 8 observaciones y 7 variables del conjunto de datos *loan50* que se encuentran disponibles en el paquete *openintro*.
